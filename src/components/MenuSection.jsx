...
export default function MenuSection() {
  ...
  return (
    <section id="menu" className="relative bg-dark-900 py-16 md:py-24 lg:py-32">
        ...
        >
          {menuItems.map((item) => (
            ...
            >
              ...
              <div className="p-4">
                <h3 className="font-elegant text-xl font-semibold text-white mb-1 group-hover:text-brand-300 transition-colors">
                  {item.name}
                </h3>
