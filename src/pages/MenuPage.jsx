          ...
          >
            {visibleItems.map((item) => (
              <motion.div
                ...
                className="group relative overflow-hidden rounded-xl border border-white/10 bg-dark-800/50"
              >
                <div className="relative h-44 overflow-hidden">
                  ...
                  <span className="absolute top-3 left-3 rounded-sm bg-brand-500/90 px-2 py-1 font-body text-[10px] font-semibold uppercase tracking-wider text-white">
                    {item.category}
                  </span>
                  ...
                  <button
                    ...
                    className={`mt-4 inline-flex items-center justify-center gap-2 rounded-sm px-4 py-2 font-body text-xs font-semibold uppercase tracking-wider transition-all duration-300 ${
                      addedId === item.id
                        ...
                        : "border border-brand-400 bg-brand-500/15 text-white hover:bg-brand-500 hover:text-white"
                    }`}
                  >
                    {addedId === item.id ? (
                      <>
